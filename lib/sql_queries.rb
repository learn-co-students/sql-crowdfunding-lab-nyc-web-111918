...
#Select the projects title and the sum of the pledges amount / the projects funding goal
# from the projects
# Join the pledges
# with projects.id = Pledges.projects_id
# Group by projects title
...
"SELECT Projects.category, ROUND(pledges.amount,1)
 FROM Projects
 JOIN Pledges
 ON Projects.id = Pledges.project_id
